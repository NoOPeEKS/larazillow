...
<form @submit.prevent="create">
  <div class="grid grid-cols-6 gap-4">
    <div class="col-span-2">
      ...
      <input v-model.number="form.beds" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600"/>
    ...
    <div class="col-span-2">
      ...
      <input v-model.number="form.baths" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600" />
    ...
    <div class="col-span-2">
      ...
      <input v-model.number="form.area" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600"/>
    ...
    <div class="col-span-4">
      ...
      <input v-model="form.city" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600"/>
    ...
    <div class="col-span-2">
      ...
      <input v-model="form.code" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600"/>
    ...
    <div class="col-span-4">
      ...
      <input v-model="form.street" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600"/>
    ...
    <div class="col-span-2">
      ...
      <input v-model.number="form.street_nr" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600"/>
    ...
    <div class="col-span-6">
      ...
      <input v-model.number="form.price" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600"/>
